...
const mainKey = "ae29fe13720ac5693cd9cf2f7972470c"; // 高德开发者 Key
const getWeather = () => {
      ...
      fetch(
        ...
        .then((res) => {
          if (res.status) {
            ...
            console.error("天气信息获取失败 (༎ຶ⌑༎ຶ)");
            iziToast.show({
              timeout: 2000,
              icon: "fa-solid fa-cloud-sun",
              message: "天气信息获取失败 (༎ຶ⌑༎ຶ)",
            });
          }
        });
    })
    .catch((err) => {
      console.error("天气信息获取失败： (༎ຶ⌑༎ຶ)" + err);
      iziToast.show({
        timeout: 2000,
        icon: "fa-solid fa-cloud-sun",
        message: "天气信息获取失败 (༎ຶ⌑༎ຶ)",
...
$("#github")
  .mouseover(function () {
    $("#link-text").html("去 全球最大的同性交友软件 看看");
  })
  .mouseout(function () {
    $("#link-text").html("点我٩(๑`^´๑)۶");
  });
$("#qq")
  .mouseover(function () {
    $("#link-text").html("你有事吗");
...
$("#switchmore").on("click", function () {
  ...
  if (shoemore && $(document).width() >= 990) {
    ...
    $("#change").html("Oops&nbsp;!");
    $("#change1").html("哎呀，这都被你发现了 ( つ•̀ω•́)つ（ 再点击一次可关闭 ）");
  } else {
    $("#container").attr("class", "container");
    $("#change").html("Hello&nbsp;World&nbsp;!");
    $("#change1").html("一言正在努力加载中...");
  }
});
...
$$ |\$  /$$ |$$   ____|        $$ |  $$ |$$ |  $$ |$$ |      $$ |  $$ |    $$ |$$ |  $$ |$$ |     $$ |  $$ |
$$ | \_/ $$ |\$$$$$$$\         $$$$$$$  |\$$$$$$  |$$ |      \$$$$$$  |$$\ $$ |$$ |  $$ |$$ |     \$$$$$$  |
\__|     \__| \_______|        $$  ____/  \______/ \__|       \______/ \__|\__|\__|  \__|\__|      \______/ 
                               $$ |                                                                         
                               $$ |                                                                         
                               \__|                                                                         
...
主页:  https://www.mepuru.info/
Github:  https://github.com/mapleawaa/Static-Pages
`;
console.log(
  `%c${title1} %c${title2}
%c${content}`,
